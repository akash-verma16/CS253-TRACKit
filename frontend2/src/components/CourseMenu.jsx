...
export default function CourseMenu({course}) {
    ...
    const tabs = [
      { id: 'coursehome', label: 'Course Home', icon: <GoHome /> , link:"/courses/coursehome"},
      { id: 'lectures', label: 'Lectures', icon: <PiGraduationCap />, link:"/courses/lectures" },
      { id: 'announcements', label: 'Announcements', icon: <TfiAnnouncement />, link:"/courses/announcements" },
      { id: 'calendar', label: 'Calendar', icon: <IoCalendarNumberOutline />, link:"/courses/calendar" },
      { id: 'result', label: 'Result', icon: <IoNewspaperOutline />, link:"/courses/result" },
      { id: 'forum', label: 'Forum', icon: <MdOutlineForum />, link:"/courses/forum" },
    ];
