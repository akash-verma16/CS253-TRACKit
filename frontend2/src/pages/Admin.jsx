      ...
      <div className='w-full'>
        <div className='w-10/12 m-auto grid grid-cols-3'>
            ...
            <div className='m-auto mb-8'>
                ...
                <p className='bg-[#D9D9D9] w-11/12 m-auto text-center py-[12px] font-semibold mt-2 rounded-md hover:scale-95 duration-200 transition-all'>Create Courses</p>
            </div>
            <div className='m-auto mb-8'>
            ...
            <div className='m-auto mb-8'>
                <img src={cntDev} alt="" />
                <p className='bg-[#D9D9D9] w-11/12 m-auto text-center py-[12px] font-semibold mt-2 rounded-md hover:scale-95 duration-200 transition-all'>Contact Developers</p>
            </div>
        </div>
      </div>
    </div>
